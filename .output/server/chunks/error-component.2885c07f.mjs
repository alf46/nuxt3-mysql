...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.1a726a3d.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.fe5e7843.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.2885c07f.mjs.map
