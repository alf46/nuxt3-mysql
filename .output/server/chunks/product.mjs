...
const require$$0$5 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(sqlstring);

const require$$0$4 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(net);
...
const require$$0$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(iconvLite);

const Iconv = require$$0$3;
...
class Packet$l {
  ...
  clone() {
    return new Packet$l(this.sequenceId, this.buffer, this.start, this.end);
  }
  ...
  static lengthCodedStringLength(str, encoding) {
    ...
    return Packet$l.lengthCodedNumberLength(slen) + slen;
  }
...
const require$$0$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(process$2);
...
const require$$15 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(crypto);
...
class Handshake {
  ...
  setScrambleData(cb) {
    require$$15.randomBytes(20, (err, data) => {
      if (err) {
        cb(err);
        return;
      }
...
class Command$b extends EventEmitter {
  constructor() {
    super();
    this.next = null;
  }
...
const require$$0$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(zlib);
...
const Packets$8 = packets.exports;
...
class ClientHandshake$2 extends Command$a {
...
const Packets$7 = packets.exports;

class ServerHandshake$1 extends Command$9 {
  constructor(args) {
    super();
    this.args = args;
    /*
...
function compile$1(fields, options, config) {
  ...
  let fieldName = '';
  for (let i = 0; i < fields.length; i++) {
    fieldName = helpers$1.srcEscape(fields[i].name);
    parserFn(`// ${fieldName}: ${typeNames$1[fields[i].columnType]}`);
    if (typeof options.nestTables === 'string') {
      lvalue = `result[${helpers$1.srcEscape(
        fields[i].table + options.nestTables + fields[i].name
      )}]`;
    } else if (options.nestTables === true) {
      lvalue = `result[${helpers$1.srcEscape(fields[i].table)}][${fieldName}]`;
...
const Packets$6 = packets.exports;
...
class Query$2 extends Command$8 {
...
const Packets$5 = packets.exports;

class CloseStatement$2 extends Command$7 {
  constructor(id) {
    super();
    this.id = id;
  }
...
const Query$1 = query;
const Packets$4 = packets.exports;

const getBinaryParser = binary_parser;

class Execute$2 extends Command$6 {
  constructor(options, callback) {
    super();
...
const Packets$3 = packets.exports;
...
class Prepare$1 extends Command$5 {
  constructor(options, callback) {
    super();
  ...
  prepareHeader(packet, connection) {
    ...
    if (this.parameterCount > 0) {
      return Prepare$1.prototype.readParameter;
  ...
  readParameter(packet, connection) {
    ...
    if (this.parameterDefinitions.length === this.parameterCount) {
      return Prepare$1.prototype.parametersEOF;
    }
  ...
  readField(packet, connection) {
    ...
    if (this.fields.length === this.fieldCount) {
      return Prepare$1.prototype.fieldsEOF;
    }
    return Prepare$1.prototype.readField;
  }
...
class Ping$1 extends Command$4 {
...
const Packets$2 = packets.exports;

class RegisterSlave$1 extends Command$3 {
...
const Packets$1 = packets.exports;
...
class BinlogDump$1 extends Command$2 {
  constructor(opts) {
    super();
    // this.onResult = callback;
    this.opts = opts;
...
class ChangeUser$1 extends Command$1 {
  constructor(options, callback) {
    super();
    this.onResult = callback;
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(url);
...
function requirePromise () {
	...
	promise.createConnection = createConnection;
	promise.createPool = createPool;
	promise.createPoolCluster = createPoolCluster;
	promise.escape = core.escape;
	promise.escapeId = core.escapeId;
	promise.format = core.format;
	promise.raw = core.raw;
	promise.PromisePool = PromisePool;
	promise.PromiseConnection = PromiseConnection;
	promise.PromisePoolConnection = PromisePoolConnection;
	return promise;
}
...
const product = defineEventHandler(async (event) => {
  ...
  const connection = await promiseExports.createConnection(
    {
